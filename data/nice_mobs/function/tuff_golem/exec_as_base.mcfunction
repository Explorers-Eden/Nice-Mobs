...
execute as @s[tag=!is_holding] store result entity @n[type=item_display,tag=aj.tuff_golem.root,distance=..2] Rotation[0] float 0.0001 run data get entity @s Rotation[0] 10000
