...
data modify entity @n[type=minecraft:villager,tag=nice_mobs.tuff_golem.vehicle,distance=..3] data.nice_mobs.variant set value "green"
execute as @n[type=minecraft:villager,tag=nice_mobs.tuff_golem.vehicle,distance=..3] on passengers run function animated_java:tuff_golem/variants/green/apply
