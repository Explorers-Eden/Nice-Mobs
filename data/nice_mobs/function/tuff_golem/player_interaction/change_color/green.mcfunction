...
tag @n[type=minecraft:villager,tag=nice_mobs.tuff_golem.vehicle,distance=..3] add nice_mobs.tuff_golem.green
...
execute as @n[type=minecraft:villager,tag=nice_mobs.tuff_golem.green,distance=..3] on passengers run function animated_java:tuff_golem/variants/green/apply
