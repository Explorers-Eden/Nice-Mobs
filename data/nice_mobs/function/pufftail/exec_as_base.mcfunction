...
execute as @s[predicate=eden:percentages/33] if entity @e[type=player,gamemode=!creative,gamemode=!spectator,distance=..48] run scoreboard players add @s nice_mobs.entity.generic_timer 1
...
execute as @s unless data entity @s data.nice_mobs{animation:"idle"} unless predicate eden:entity/is_flying run function nice_mobs:pufftail/behavior/idle
execute as @s unless data entity @s data.nice_mobs{animation:"fly"} if predicate eden:entity/is_flying run function nice_mobs:pufftail/behavior/fly

#apply textures when hurt or not
execute if data entity @s data.nice_mobs{hurt: 0b} unless predicate eden:entity/has_no_hurttime run function nice_mobs:pufftail/behavior/hurt/start with entity @s data.nice_mobs
execute if data entity @s data.nice_mobs{hurt: 1b} if predicate eden:entity/has_no_hurttime run function nice_mobs:pufftail/behavior/hurt/end with entity @s data.nice_mobs
