...
Silent:1b,\
Health:16f,\
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"cyan"}},\
Tags:["nice_mobs.base","nice_mobs.jellyfish.vehicle","eden.settings.applied","eden.equipped","eden.rarity_mob"],\
...
function animated_java:jellyfish/summon {args: {variant: "cyan"}}
