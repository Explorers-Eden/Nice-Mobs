...
Saddle:0b,\
Age:2400,\
data:{nice_mobs:{spawned_in_version:"2.1",action:0b,animation:"default",hurt:0b,variant:"red",is_bartering:0b}},\
...
function animated_java:enderkin/summon {args: {variant: "red"}}
