...
Saddle:0b,\
Age:2400,\
data:{nice_mobs:{spawned_in_version:"2.1",action:0b,animation:"default",hurt:0b,variant:"yellow",is_bartering:0b}},\
...
function animated_java:enderkin/summon {args: {variant: "yellow"}}
...
execute as @n[type=item_display,tag=aj.enderkin.root,tag=!nice_mobs.has_vehicle,distance=..3] run data modify entity @s Rotation[1] set value 0f
