...
Saddle:0b,\
Age:2400,\
data:{nice_mobs:{spawned_in_version:"1.9",action:0b,animation:"default",hurt:0b,variant:"green",is_bartering:0b}},\
...
function animated_java:enderkin/summon {args: {variant: "green"}}
