...
DeathLootTable:"nice_mobs:entity/rat",\
...
Saddle:0b,\
Age:2400,\
data:{nice_mobs:{spawned_in_version:"2.1",action:0b,animation:"default",hurt:0b,variant:"gray",is_eating:0b}},\
Tags:["nice_mobs.base","nice_mobs.rat.vehicle","mob_manager.settings.exclude"],\
attributes:[{id:"minecraft:max_health",base:14},{id:"minecraft:movement_speed",base:.24},{id:"minecraft:scale",base:0.22}]\
}

function animated_java:rat/summon {args: {variant: "gray"}}
...
scoreboard players set @n[type=pig,tag=nice_mobs.rat.vehicle,tag=!nice_mobs.has_passenger,distance=..3] nice_mobs.entity.generic_timer 0
