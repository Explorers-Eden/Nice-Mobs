...
DeathLootTable:"nice_mobs:entity/cruncher",\
...
Health:30f,\
Age:2400,\
data:{nice_mobs:{spawned_in_version:"2.1",action:0b,animation:"default",hurt:0b,variant:"default",ore_type_last_eaten:"none",inventory:{coal:0,copper:0,iron:0,redstone:0,lapis:0,diamond:0,gold:0,emerald:0}}},\
Tags:["nice_mobs.base","nice_mobs.cruncher.vehicle","mob_manager.settings.exclude"],\
