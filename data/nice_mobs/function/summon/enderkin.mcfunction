...
execute if score $enderkin_type eden.technical matches 1..3 run function nice_mobs:summon/enderkin/pink
execute if score $enderkin_type eden.technical matches 4 run function nice_mobs:summon/enderkin/white
