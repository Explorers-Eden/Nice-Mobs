...
Saddle:0b,\
Age:2400,\
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"brown"}},\
Tags:["nice_mobs.base","nice_mobs.hedgehog.vehicle","eden.settings.applied","eden.equipped","eden.rarity_mob"],\
attributes:[{id:"minecraft:max_health",base:14},{id:"minecraft:movement_speed",base:.1},{id:"minecraft:scale",base:0.43}]\
}

function animated_java:hedgehog/summon {args: {variant: "brown"}}
