...
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"wisp_ethereal",effect:"minecraft:slow_falling"}},\
...
function animated_java:butterfly/summon {args: {variant: "wisp_ethereal"}}
