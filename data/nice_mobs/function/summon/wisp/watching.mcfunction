...
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"wisp_watching",effect:"minecraft:glowing"}},\
...
function animated_java:butterfly/summon {args: {variant: "wisp_watching"}}
