...
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"wisp_flourishing",effect:"minecraft:saturation"}},\
Tags:["nice_mobs.base","nice_mobs.butterfly.vehicle","eden.scaled","eden.baby_mount.set","eden.tweaked","eden.equipped","eden.rarity_mob","nice_mobs.wisp.vehicle"],\
...
function animated_java:butterfly/summon {args: {variant: "wisp_flourishing"}}
