...
DeathLootTable:"nice_mobs:entity/wisp",\
Silent:1b,\
PersistenceRequired:1b,\
CanPickUpLoot:0b,\
Health:10f,\
CannotEnterHiveTicks:9999,\
data:{nice_mobs:{spawned_in_version:"2.1",action:0b,animation:"default",hurt:0b,variant:"wisp_flourishing",effect:"minecraft:saturation"}},\
