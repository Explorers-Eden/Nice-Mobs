...
data:{nice_mobs:{action:0b,animation:"default",hurt:0b,variant:"moth_luna",effect:"minecraft:luck"}},\
...
function animated_java:butterfly/summon {args: {variant: "moth_luna"}}
