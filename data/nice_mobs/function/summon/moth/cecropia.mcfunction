...
DeathLootTable:"nice_mobs:entity/moth",\
Silent:1b,\
PersistenceRequired:1b,\
CanPickUpLoot:0b,\
Health:10f,\
CannotEnterHiveTicks:9999,\
data:{nice_mobs:{spawned_in_version:"2.0",action:0b,animation:"default",hurt:0b,variant:"moth_cecropia",effect:"minecraft:bad_omen"}},\
