...
CustomName:{"bold":false,"fallback":"Moth","italic":false,"translate":"entity.nice_mobs.moth"},\
DeathLootTable:"eden:entity/moth",\
Silent:1b,\
PersistenceRequired:1b,\
CanPickUpLoot:0b,\
Health:10f,\
CannotEnterHiveTicks:9999,\
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"moth_cecropia",effect:"minecraft:bad_omen"}},\
Tags:["nice_mobs.base","nice_mobs.butterfly.vehicle","eden.scaled","eden.baby_mount.set","eden.tweaked","eden.equipped","eden.rarity_mob","nice_mobs.moth.vehicle"],\
...
function animated_java:butterfly/summon {args: {variant: "moth_cecropia"}}
