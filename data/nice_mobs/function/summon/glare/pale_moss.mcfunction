...
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"pale"}},\
Tags:["nice_mobs.base","nice_mobs.glare.vehicle","eden.settings.applied","eden.equipped","eden.rarity_mob"],\
