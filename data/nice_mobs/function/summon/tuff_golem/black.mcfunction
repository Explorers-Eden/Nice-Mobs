...
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"black",holds_item:0b}},\
...
function animated_java:tuff_golem/summon {args: {variant: "black"}}
