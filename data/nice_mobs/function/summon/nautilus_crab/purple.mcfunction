...
Saddle:0b,\
Age:2400,\
data:{nice_mobs:{spawned_in_version:"2.0",action:0b,animation:"default",hurt:0b,variant:"purple"}},\
...
function animated_java:nautilus_crab/summon {args: {variant: "purple"}}
