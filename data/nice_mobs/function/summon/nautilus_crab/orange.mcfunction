...
DeathLootTable:"nice_mobs:entity/nautilus_crab",\
...
Saddle:0b,\
Age:2400,\
data:{nice_mobs:{spawned_in_version:"2.1",action:0b,animation:"default",hurt:0b,variant:"orange"}},\
...
function animated_java:nautilus_crab/summon {args: {variant: "orange"}}
