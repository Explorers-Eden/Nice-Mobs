...
data:{nice_mobs:{spawned_in_version:1.7d,action:0b,animation:"default",hurt:0b,variant:"tiger",effect:"minecraft:jump_boost"}},\
...
function animated_java:butterfly/summon {args: {variant: "tiger"}}
