...
#init eating
execute as @e[type=item,predicate=nice_mobs:entity/is_rotten_flesh_item] at @s if entity @e[type=pig,tag=nice_mobs.rat.vehicle,distance=..1] run function nice_mobs:rat/behavior/eating/init

#on death
execute as @e[type=item_display,tag=aj.rat.root,predicate=!nice_mobs:entity/has_pig_vehicle] at @s run function nice_mobs:rat/behavior/death
