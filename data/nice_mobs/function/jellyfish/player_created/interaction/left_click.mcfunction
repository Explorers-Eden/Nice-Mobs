...
execute as @e[type=minecraft:interaction,tag=nice_mobs.jellyfish.crafted.interaction,distance=..16] if data entity @s attack at @s run loot spawn ~ ~ ~ loot eden:item/dried_jellyfish
