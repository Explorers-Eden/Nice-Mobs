...
#vulture spawning
execute as @a[scores={nice_mobs.player.health=..6},predicate=eden:percentages/25] run scoreboard players add @a nice_mobs.player.vulture_timer 1
execute as @a[predicate=!eden:entity/can_spawn_vulture] run scoreboard players set @a nice_mobs.player.vulture_timer 0
...
#on death
execute as @e[type=item_display,tag=aj.vulture.root,predicate=!eden:entity/has_phantom_vehicle] at @s run function nice_mobs:vulture/behavior/death
