...
CustomName:'{"bold":false,"italic":false,"text":"Copper Golem"}',\
DeathLootTable:"eden:entity/copper_golem",\
PersistenceRequired:1b,\
CanPickUpLoot:0b,\
Health:60f,\
Tags:["nice_mobs.base","nice_mobs.copper_golem.vehicle","eden.scaled","eden.baby_mount.set"],\
...
scoreboard players set @n[type=iron_golem,tag=nice_mobs.copper_golem.vehicle,tag=!nice_mobs.has_passenger,distance=..3] nice_mobs.entity.timer 0
