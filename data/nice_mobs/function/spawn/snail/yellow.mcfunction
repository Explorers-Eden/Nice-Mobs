...
function animated_java:snail/summon {args: {variant: "yellow"}}
tag @n[type=pig,tag=nice_mobs.snail.vehicle,tag=!nice_mobs.has_passenger,distance=..3] add nice_mobs.snail.yellow
