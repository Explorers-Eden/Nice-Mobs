...
data:{nice_mobs:{action:0b,animation:"default",hurt:0b,variant:"wisp_arctic",effect:"minecraft:fire_resistance"}},\
...
function animated_java:butterfly/summon {args: {variant: "wisp_arctic"}}
tag @n[type=bee,tag=nice_mobs.butterfly.vehicle,tag=!nice_mobs.has_passenger,distance=..3] add nice_mobs.wisp.arctic
