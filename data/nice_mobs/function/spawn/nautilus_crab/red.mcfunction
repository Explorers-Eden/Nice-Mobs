...
function animated_java:nautilus_crab/summon {args: {}}
tag @n[type=pig,tag=nice_mobs.nautilus_crab.vehicle,tag=!nice_mobs.has_passenger,distance=..3] add nice_mobs.nautilus_crab.red
