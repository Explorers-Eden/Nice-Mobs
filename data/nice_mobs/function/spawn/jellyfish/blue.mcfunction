...
function animated_java:jellyfish/summon {args: {variant: "blue"}}
tag @n[type=wither_skeleton,tag=nice_mobs.jellyfish.vehicle,tag=!nice_mobs.has_passenger,distance=..3] add nice_mobs.jellyfish.blue
