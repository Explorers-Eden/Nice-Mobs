...
tag @n[type=bee,tag=nice_mobs.butterfly.vehicle,tag=!nice_mobs.has_passenger,distance=..3] add nice_mobs.butterfly.monarch
...
execute as @n[type=item_display,tag=aj.butterfly.root,tag=!nice_mobs.has_vehicle,distance=..3] run function animated_java:butterfly/animations/fly/play
