...
execute unless entity @e[type=#nice_mobs:is_nice_mobs_vehicle,tag=nice_mobs.base] run return fail

#clear glowing
effect clear @e[type=#nice_mobs:is_nice_mobs_vehicle,type=!#nice_mobs:is_data_driven_mob,tag=nice_mobs.base] minecraft:glowing
execute as @e[type=#nice_mobs:is_data_driven_mob,tag=nice_mobs.base] if predicate nice_mobs:entity/is_glowing on passengers on passengers run data modify entity @s Glowing set value 1b
execute as @e[type=#nice_mobs:is_data_driven_mob,tag=nice_mobs.base] unless predicate nice_mobs:entity/is_glowing on passengers on passengers run data modify entity @s Glowing set value 0b
...
#modify age
execute as @e[type=#nice_mobs:is_nice_mobs_vehicle,tag=nice_mobs.base] run data modify entity @s Age set value 2400

#give non data driven vehicles invisible effect in case they lost it
effect give @e[type=!#nice_mobs:is_data_driven_mob,tag=nice_mobs.base] invisibility infinite 0 true