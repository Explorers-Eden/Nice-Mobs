...
#init eating
execute as @e[type=item] at @s if items entity @s container.* #eden:ores if entity @e[type=pig,tag=nice_mobs.cruncher.vehicle,distance=..1,scores={nice_mobs.cruncher.ores_holding=..1727}] run function nice_mobs:cruncher/behavior/eating/init
