...
execute if items entity @s container.* #eden:stone_ores run data modify entity @n[type=pig,tag=nice_mobs.cruncher.vehicle,tag=!is_eating,distance=..1,scores={nice_mobs.cruncher.ores_holding=..1727}] data.nice_mobs.ore_type_last_eaten set value "stone"
execute if items entity @s container.* #eden:deepslate_ores run data modify entity @n[type=pig,tag=nice_mobs.cruncher.vehicle,tag=!is_eating,distance=..1,scores={nice_mobs.cruncher.ores_holding=..1727}] data.nice_mobs.ore_type_last_eaten set value "deepslate"
