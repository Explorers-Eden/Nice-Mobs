...
#init bartering
execute as @e[type=item,predicate=eden:entity/is_cod_item] at @s if entity @e[type=chicken,tag=nice_mobs.penguin.vehicle,distance=..1] run function nice_mobs:penguin/behavior/bartering/init
