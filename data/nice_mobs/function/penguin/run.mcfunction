...
#on death
execute as @e[type=item_display,tag=aj.penguin.root,predicate=!eden:entity/has_pig_vehicle] at @s run function nice_mobs:penguin/behavior/death

#run functions as base entity
execute as @e[type=pig,tag=nice_mobs.penguin.vehicle] at @s run function nice_mobs:penguin/exec_as_base