...
execute as @s[tag=!is_idle,scores={nice_mobs.entity.timer=960..}] if predicate eden:entity/is_idle unless predicate eden:location/stepping_on_dirt run function nice_mobs:mushling/behavior/idle
execute as @s[tag=!is_walking] if predicate eden:entity/is_walking run function nice_mobs:mushling/behavior/walk

#apply textures when hurt or not
execute as @s[tag=!is_hurt] unless predicate eden:entity/has_no_hurttime run function nice_mobs:mushling/behavior/hurt/start
execute as @s[tag=!not_hurt,scores={nice_mobs.entity.is_hurt=1..}] if predicate eden:entity/has_no_hurttime run function nice_mobs:mushling/behavior/hurt/end
