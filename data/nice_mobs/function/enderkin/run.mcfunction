...
#init bartering
execute as @e[type=item,predicate=eden:entity/is_cod_item] at @s if entity @e[type=pig,tag=nice_mobs.enderkin.vehicle,distance=..1] run function nice_mobs:enderkin/behavior/bartering/init
