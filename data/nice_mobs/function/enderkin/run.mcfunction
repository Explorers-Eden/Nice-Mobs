...
#init bartering
execute as @e[type=item,predicate=nice_mobs:entity/is_diamond_item] at @s if entity @e[type=pig,tag=nice_mobs.enderkin.vehicle,distance=..1] run function nice_mobs:enderkin/behavior/bartering/init

#on death
execute as @e[type=item_display,tag=aj.enderkin.root,predicate=!nice_mobs:entity/has_pig_vehicle] at @s run function nice_mobs:enderkin/behavior/death
