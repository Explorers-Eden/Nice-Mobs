...
execute if items entity @s weapon.mainhand #eden:valid_for_dirt_golem at @s positioned ^ ^ ^3 run return run function nice_mobs:dirt_golem/player_interaction/check_item
