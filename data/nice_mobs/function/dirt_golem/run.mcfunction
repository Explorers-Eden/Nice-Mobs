...
#on death
execute as @e[type=item_display,tag=aj.dirt_golem.root,predicate=!nice_mobs:entity/has_villager_vehicle] at @s run function nice_mobs:dirt_golem/behavior/death
