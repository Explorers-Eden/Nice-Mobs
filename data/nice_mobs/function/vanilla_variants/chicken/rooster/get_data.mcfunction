execute unless predicate nice_mobs:percentages/33 run return fail
...
execute if predicate nice_mobs:entity/is_adult run function nice_mobs:vanilla_variants/chicken/rooster/exec with entity @s data.nice_mobs
