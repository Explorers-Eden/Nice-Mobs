...
execute unless entity @s[type=minecraft:item_display,tag=aj.cruncher.root] run return run function animated_java:global/errors/function_not_executed_as_root_entity {'export_namespace': 'cruncher', 'function_path': 'animated_java:cruncher/animations/walk/tween'}
