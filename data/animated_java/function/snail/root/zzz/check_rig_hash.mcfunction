...
function animated_java:snail/root/zzz/show_outdated_warning with storage aj:temp args
data modify entity @s data.rigHash set value '7691f39e06af8600857915cd3ae2f9922402c7e2033a3fdbddc1d4b6c0ef6b9f'
