...
execute on passengers if entity @s[tag=aj.global.data] run function animated_java:treasure_chest/zzz/summon/as_data_entity
execute if data storage aj:temp args.variant run function animated_java:treasure_chest/zzz/summon/zzz/variant_arg/no_variants_warning
