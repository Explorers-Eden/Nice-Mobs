...
function animated_java:cruncher/root/outdated_tellraw with storage aj:temp
data modify entity @s data.rigHash set value 'c5d4fc0278bd5ddeaea2feedbc9ce1265c55222458ddc67c965d136ea66709d8'
